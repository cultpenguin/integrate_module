...
N=2000000
#N=50000
f_data_h5 = 'SOELBALLE_AVG.h5'
#f_data_h5 = '20201112_AVG_export.h5'
#f_data_h5 = '20201203_AVG_export.h5'
...
# %% TEST NEW GEX TYPE FILE
#GEX = ig.read_gex(file_gex)
GEX = ig.read_gex_workbench(file_gex)
...
ig.plot_feature_2d(f_post_h5,im=1,iz=5, key='Median', uselog=1, cmap='jet', s=5, hardcopy=hardcopy)
plt.show()
